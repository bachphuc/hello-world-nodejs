...
<table cellspacing="0" cellpadding="0" border="0">
<tr>
<td align="center" style="vertical-align: middle; background-color:#ffffff;   padding-left:50px; padding-right:50px;" bgcolor="#ffffff">
<table width="100%" border="0" cellpadding="0" cellspacing="0">
<tr>
<td>
...
<tr>
<td style="vertical-align: middle;" width="500" align="center"><img src="https://ec.xnglobalres.com/rdp/basestackliving/resource/email_bsl_logo.png" width="500" border="0" style="max-width:500px; width: 100%;
...
<tr>
<td style="vertical-align: middle;" align="center">
<div style="line-height:24px;text-align:center;"><span style="color:#292929;font-weight:350;font-family:TWK Lausanne,Arial,sans-serif;font-size:26px;line-height:24px;text-align:center;">Please verify your email to complete <br>your room booking.</span></div>
</td>
</tr>
</table>
</td>
...
<div>
<!--[if mso]>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ url | escape }}" style="height:64px;v-text-anchor:middle;width:181px;" fillcolor="#ffffff"  stroke="f" arcsize="55%">
                        <w:anchorlock/>
                        <center style="white-space:nowrap;display:inline-block;text-align:center;color:#292929;font-weight:550;font-family:Trois Mille Medium,Arial,sans-serif;font-size:20px;">Verify Email</center>
                        </v:roundrect>
                    <![endif]-->
<a href="{{ url | escape }}" style="white-space:nowrap;background-color:#ffffff;border-radius:35px; display:inline-block;text-align:center;color:#292929;font-weight:550;font-family:Trois Mille Medium,Arial,sans-serif;font-size:20px;line-height:64px;width:181px; -webkit-text-size-adjust:none;mso-hide:all;box-shadow: 0px 5px 10px 0px rgba(0, 0, 0, 0.15000000596046448);">Verify Email</a>
</div>
</td>
</tr>
</table>
