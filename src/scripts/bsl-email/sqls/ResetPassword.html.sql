...
<table cellspacing="0" cellpadding="0" border="0">
<tr>
<td style="vertical-align: middle;" width="250" align="center"><img src="https://ec.xnglobalres.com/rdp/basestackliving/resource/email_bsl_logo.png" width="250" border="0" style="max-width:250px; width: 100%;
...
<tr>
<td style="vertical-align: middle;" align="center">
<div style="line-height:36px;text-align:center;"><span style="color:#292929;font-weight:700;font-family:TWK Lausanne,Arial,sans-serif;font-size:24px;line-height:36px;text-align:center;">Hi {{ user.name | escape }}</span></div>
</td>
</tr>
<tr>
<td>
...
<tr>
<td style="vertical-align: middle;" align="center">
<div style="line-height:24px;text-align:center;"><span style="color:#292929;font-weight:350;font-family:TWK Lausanne,Arial,sans-serif;font-size:26px;line-height:24px;text-align:center;">Did you forget your password?</span></div>
</td>
</tr>
</table>
</td>
...
<tr>
<td style="vertical-align: middle;" align="center">
<div style="line-height:20px;text-align:left;"><span style="color:#292929;font-weight:350;font-family:TWK Lausanne,Arial,sans-serif;font-size:16px;line-height:20px;text-align:left;">If so, click the link below to reset it. <br>This link will expire within 5 minutes.</span></div>
</td>
</tr>
</table>
</td>
...
<div>
<!--[if mso]>
                        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ url | escape }}" style="height:64px;v-text-anchor:middle;width:228px;" fillcolor="#8c1101"  stroke="f" arcsize="55%">
                        <w:anchorlock/>
                        <center style="white-space:nowrap;display:inline-block;text-align:center;color:#fff3e4;font-weight:550;font-family:Trois Mille Medium,Arial,sans-serif;font-size:20px;">Reset Password </center>
                        </v:roundrect>
                    <![endif]-->
<a href="{{ url | escape }}" style="white-space:nowrap;background-color:#8c1101;border-radius:35px; display:inline-block;text-align:center;color:#fff3e4;font-weight:550;font-family:Trois Mille Medium,Arial,sans-serif;font-size:20px;line-height:64px;width:228px; -webkit-text-size-adjust:none;mso-hide:all;box-shadow: 0px 5px 10px 0px rgba(0, 0, 0, 0.15000000596046448);">Reset Password </a>
</div>
</td>
</tr>
</table>
...
<tr>
<td>
<div style="line-height:25px;text-align:left;"><span style="color:#292929;font-weight:700;font-family:TWK Lausanne,Arial,sans-serif;font-size:16px;line-height:25px;text-align:left;">The BaseStack Bryggen Team</span></div>
</td>
</tr>
</table>
</td>
...
<table cellspacing="0" cellpadding="0" border="0">
<tr>
<td><a href="#"><img src="https://ec.xnglobalres.com/rdp/basestackliving/resource/email_socials_img.png" width="144" border="0" style="min-width:144px; width:144px;
