...
namespace XHS.DataAccess
{
	...
	public partial class DAC_{Table_Name} : DataAccessBase
	{
		...
		public DAC_{Table_Name}(SqlConnection dbConnection) :
			base(dbConnection)
		{
        ...
        protected void Fill(SqlDataReader objDataReader, ref {Table_Name} obj{Table_Name})
        {
            ...
            obj{Table_Name}.CreatedByUser = ReadUserAccount(objDataReader, (int){Table_Name}Column.Create_User_Account_ID, (int){Table_Name}Column.CreatedByLogonName, (int){Table_Name}Column.CreatedByFirstName, (int){Table_Name}Column.CreatedByLastName);
            obj{Table_Name}.UpdatedByUser = ReadUserAccount(objDataReader, (int){Table_Name}Column.Update_User_Account_ID, (int){Table_Name}Column.UpdatedByLogonName, (int){Table_Name}Column.UpdatedByFirstName, (int){Table_Name}Column.UpdatedByLastName);
